...
- `autohotkey-scripts/default.ah2`
- `autohotkey-scripts/config.ah2`

Never modify:
- `VD.ahk/` (third-party dependency)
...
3. Update `autohotkey-scripts/default.ah2`
- Add:
...
4. Update `autohotkey-scripts/config.ah2`
- Add map entry:
...
- Confirm no edits outside `autohotkey-scripts/`.
